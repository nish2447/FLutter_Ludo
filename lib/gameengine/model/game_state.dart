...
class GameState with ChangeNotifier {
  ...
  //after moving each token to a distance
  // we update it's initial pos so in next time we start from the updated value
...
// when we cut other players token
  ...
  //get where we will go (row,column);
